Welcome 👋 My name is Nick Marshall
==============================

Web Application Engineer
------------------------

I've been writing software before git existed. Back then it was perl and Java. Now it's Java and Typescript. Although I'd love to write software in Haskell. 

* 🌍  I'm based in Northern Virginia

### A few Portfolio Apps

[Binauralbeat Meditation App](https://github.com/nmarshall23/binauralbeat-meditation-app), Been playing with ToneJs in my spare time, figured I would test to see how good Webaudio is at sound synthesis.
...
<!--
**nmarshall23/nmarshall23** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
